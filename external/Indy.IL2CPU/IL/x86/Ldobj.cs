...
namespace Indy.IL2CPU.IL.X86
{
    ...
    public class Ldobj : Op
    {
        ...
        public Ldobj(Mono.Cecil.Cil.Instruction instruction, MethodInformation aMethodInfo)
            : base(instruction, aMethodInfo)
        {
            ...
            mSize = Engine.GetFieldStorageSize(_type);
        }
        ...
        public override void DoAssemble()
        {
            ...
            Assembler.StackContents.Push(new StackContent((int)mSize, _type));
        }
    }
}