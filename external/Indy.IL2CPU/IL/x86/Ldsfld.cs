...
namespace Indy.IL2CPU.IL.X86
{
    ...
    public class Ldsfld : Op
    {
        ...
        public Ldsfld(Mono.Cecil.Cil.Instruction instruction, MethodInformation aMethodInfo)
        ...
        public override void DoAssemble()
        {
            ...
            Assembler.StackContents.Push(new StackContent((int)mSize, (TypeReference)null));
            if (mNeedsGC)
            {
                new Dup(null, null)
                {
