...
namespace Indy.IL2CPU.IL.X86
{
    ...
    {
        public X86CustomMethodImplementationOp(Mono.Cecil.Cil.Instruction instruction, MethodInformation aMethodInfo)
        ...
        protected override void Assemble_System_UInt32___Indy_IL2CPU_CustomImplementation_System_StringImpl_GetStorage___System_UInt32___()
        {
            ...
            uint xStorageSize;
            Dictionary<string, TypeInformation.Field> xFields = Engine.GetTypeFieldInfo(TypeResolver.Resolve<string>(), out xStorageSize);
